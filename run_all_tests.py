...
TESTS = [
    ...
    "test_enforcement.py", "test_ad_campaigns.py", "test_destination_state.py", "test_relay.py", "test_verification_store.py", "test_human_verification.py", "test_broadcast_lifecycle.py",
